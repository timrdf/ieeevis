...
echo "manual/*.html -> manual/*.html.csv"
saxon.sh ../../src/html2csv.xsl html csv -od manual manual/lau*.html

echo "convert-orbital-launches.sh"
if [ ! -e convert-orbital-launches.sh ]; then
