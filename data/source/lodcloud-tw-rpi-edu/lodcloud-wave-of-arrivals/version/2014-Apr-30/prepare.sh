...
# Make TTL
grddl.sh source/lod-cloud-wave-of-arrivals.svg > automatic/lod-cloud-wave-of-arrivals.ttl
justify.sh source/lod-cloud-wave-of-arrivals.svg automatic/lod-cloud-wave-of-arrivals.ttl http://dbpedia.org/resource/GRDDL
# Look at it
vsr2grf.sh rdf graffle -w automatic/lod-cloud-wave-of-arrivals.ttl
void-triples.sh automatic/lod-cloud-wave-of-arrivals.ttl
